...
if(isset($_POST["do"])&&($_POST["do"]=="update_parents_profile")){
	...
	$sql2="SELECT * FROM parents WHERE id='$id'";
	...
	if(!$name){
		...
		$sql = "update parents set full_name='".$full_name."',i_name='".$i_name."', gender='".$gender."',address='".$address."', phone='".$phone."',email='".$email."' where id='$id'";
		...
		if(move_uploaded_file($tmpname, $image_path)){
			...
			$sql = "update parents set full_name='".$full_name."',i_name='".$i_name."', gender='".$gender."',address='".$address."', phone='".$phone."',email='".$email."',image_name='".$image_path."' where id='$id'";
