...
function showModal(my_index,conversation_id,friend_index,my_type){
	...
	var xhttp = new XMLHttpRequest();//MSK-00149-Start Ajax  
    	...
    	xhttp.open("GET", "conversation_history_student.php?my_index=" + my_index + "&my_type="+my_type + "&conversation_id="+conversation_id + "&friend_index="+friend_index, true);												
					...
					xhttp1.send();
						...
						if(timer1 == 0){
							intervalID = setInterval(function(){
								...
								$('#chatRoom').load("conversation_history_student1.php?my_index="+my_index+"&conversation_id="+conversation_id+"&friend_index="+friend_index+"");
...
function showCurrentmsg(my_index,conversation_id,friend_index){
	...
	var xhttp2 = new XMLHttpRequest();//MSK-00149-Start Ajax  
		...
		xhttp2.open("GET", "conversation_history_student1.php?my_index=" + my_index + "&conversation_id="+conversation_id + "&friend_index="+friend_index, true);												
		xhttp2.send();
