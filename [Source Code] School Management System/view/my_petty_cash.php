        	...
        	<div class="col-md-10">
            	<div class="box">
                	<div class="box-header">
                  		<a href="#modalInsertform"  class="btn btn-success btn-sm pull-right" data-id="" data-toggle="modal">Add <span class="glyphicon glyphicon-plus"></span></a><!-- MSK-00094-->
                  		<h3 class="box-title">My Petty Cash History</h3>
                	</div><!-- /.box-header -->
...
$sql="select * from petty_cash where received_by='$index' and received_type='$type'";
            			...
            			<div class="panel-body"><!--panel-body -->
                        	<div class="row " id="msk12345">
                                ...
                                <div class="col-xs-4 class-email text-right ">
                                    	Email: admin@getprojects.org<br>
