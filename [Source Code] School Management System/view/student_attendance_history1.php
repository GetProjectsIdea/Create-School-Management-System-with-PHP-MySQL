...
$status5="";
$date_no2="";
$sql="select * from student_attendance where index_number='$index' and (_status1='intime' or _status1='') and year='$year' and month='$month1' order by date ";
...
echo '<div style="float:left; width:100px; " id="cal_color_hint">
