            ...
            <div class="col-md-12">
            	<div class="box">
                	<div class="box-header">
                    	<h3 class="box-title">My Son's Attendance in this Month</h3>
                	</div><!-- /.box-header -->
...
$sql="select * from student_attendance where index_number='$my_son_index' and (_status1='intime' or _status1='') and year='$current_year' and month='$current_month'";
...
if(mysqli_num_rows($result) > 0) {
	while($row=mysqli_fetch_assoc($result)){
		...
		if($status1='intime'){
			$sql2="select * from student_attendance where index_number='$my_son_index' and _status1='outtime' and date='$date'";
