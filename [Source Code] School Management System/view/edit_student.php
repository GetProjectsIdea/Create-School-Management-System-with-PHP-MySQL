                        				...
                        				<div class="col-xs-7">
                                            <div class="form-group" id="divGPhone">
                                                ...
                                                <div class="col-xs-7" id="divGPhone1">
                                                	<input type="text" class="form-control" id="g_phone" name="g_phone" value="<?php echo $row1['phone']; ?>" >
                                                </div> 
                                        	</div>
...
$("form").submit(function (e){
	...
	if(index_number == '' || g_index_number == '' || full_name == '' || g_full_name == '' || i_name == '' || g_i_name == '' || address == '' || g_address == '' || gender == 'Select Gender' || g_gender == 'Select Gender' || b_date == '' || g_b_date == '' || email == '' || mailformat.test(email) == false || g_email == '' || mailformat.test(g_email) == false || telformat.test(phone) == false || telformat.test(g_phone) == false || phone == ''  || g_phone == '' ) {
