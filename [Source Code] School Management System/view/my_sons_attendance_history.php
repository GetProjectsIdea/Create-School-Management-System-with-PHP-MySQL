...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">My Son's Attendance History</a></li>
    	</ol>
	</section>
            	...
            	<!-- general form elements -->
              	<div class="box box-primary">
                	<div class="box-header with-border">
                  		<h3 class="box-title">My Son's Attendance History</h3>
                	</div><!-- /.box-header -->
                  	<div class="box-body">
...
function showAHistory(){
	...
	var xhttp1 = new XMLHttpRequest();//MSK-000159-Start Ajax  
		...
		xhttp1.open("GET", "my_sons_attendance_history1.php?year=" + year + "&month="+month + "&my_index="+my_index  , true);												
