...
?>   
               ...
               <!--MSK-000115-td4--><td id="td_paid_<?php echo $count; ?>"><?php echo $row['paid']; ?></td>
                                    ...
                                    <td> 
<!--MSK-00102-->                                                
<a href="#" onClick="showModal3(this)" class="btn btn-info btn-xs" data-id="<?php echo $index; ?>,<?php echo $row['year']; ?>,<?php echo $row['month']; ?>">View Details</a>
<a href="#" onClick="showModal4(this)" class="btn btn-success btn-xs" data-id="<?php echo $index; ?>,<?php echo $row['_status']; ?>,<?php echo $row['paid']; ?>,<?php echo $row['year']; ?>,<?php echo $row['month']; ?>,<?php echo $row['date']; ?>" >View Invoice</a>
                               		</td>
                            	</tr>
<?php } } ?>
                        	</tbody>
